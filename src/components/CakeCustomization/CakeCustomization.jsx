...
<div className="flex flex-col">
  ...
  <div className="flex overflow-x-scroll scrollbar-width-thin scrollbar-thumb">
...
<div className="w-1/2 pr-2">
  ...
  <div className="overflow-y-auto scrollbar-width-thin scrollbar-thumb " style={{ maxHeight: '200px' }}>
    {topping.map(topping => (
